      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mb-5">
            <form action="" onsubmit="return false;" id="charmander">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Enviar mensagem" id="submitformhome" class="btn btn-primary text-white">
                </div>
              </div>
...
// });
          ...
          var form = document.querySelector('#charmander');
